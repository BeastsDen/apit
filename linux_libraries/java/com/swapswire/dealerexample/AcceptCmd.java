...
public class AcceptCmd extends DealerCmd {

    public AcceptCmd() {
        super( "Accept", "oldDealVersionHandle privateDataXML" );
    }

	public static String run( Session session, String oldDealVersionHandle, String privateDataXML ) throws ErrorCode {
        System.out.println( "Accept - " + oldDealVersionHandle );
		String[] newDealVersionHandle = { new String() };
		DealerAPIWrapper.accept( session.getLoginHandle(), oldDealVersionHandle, privateDataXML, newDealVersionHandle );
