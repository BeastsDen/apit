...
public class SubmitNewPrimeBrokerDealCmd extends DealerCmd {

    public SubmitNewPrimeBrokerDealCmd() {
        super("SubmitNewPrimeBrokerDeal", "SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        ...
        DealerAPIWrapper.submitNewPrimeBrokerDeal(session.getLoginHandle(), swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
