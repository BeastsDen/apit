...
public class SubmitNovationCmd extends DealerCmd {

    public SubmitNovationCmd() {
        super("SubmitNovation", "oldDealVersionHandle SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String oldDealVersionHandle, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        System.out.println("Submitting a novation - " + oldDealVersionHandle);
        String[] newDealVersionHandle = {new String()};
        DealerAPIWrapper.submitNovation(session.getLoginHandle(), oldDealVersionHandle, swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
        System.out.println("Novation submitted OK");
