...
public class SubmitPrimeBrokerAmendmentCmd extends DealerCmd {

    public SubmitPrimeBrokerAmendmentCmd() {
        super("SubmitPrimeBrokerAmendment", "oldDealVersionHandle SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String oldDealVersionHandle, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        System.out.println("Submitting a prime broker amendment - " + oldDealVersionHandle);
        String[] newDealVersionHandle = {new String()};
        DealerAPIWrapper.submitPrimeBrokerAmendment(session.getLoginHandle(), oldDealVersionHandle, swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
        System.out.println("Prime broker amendment submitted OK");
