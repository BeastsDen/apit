...
public class SubmitDraftNewPrimeBrokerDealCmd extends DealerCmd {

    public SubmitDraftNewPrimeBrokerDealCmd() {
        super("SubmitDraftNewPrimeBrokerDeal", "SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        System.out.println("Submitting new prime broker draft deal");
        String[] newDealVersionHandle = {new String()};
        DealerAPIWrapper.submitDraftNewPrimeBrokerDeal(session.getLoginHandle(), swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
        System.out.println("Draft prime broker deal Submitted OK");
