...
public class SubmitDraftAmendmentCmd extends DealerCmd {

    public SubmitDraftAmendmentCmd() {
        super("SubmitDraftAmendment", "oldDealVersionHandle SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String oldDealVersionHandle, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        System.out.println("Submitting an amendment - " + oldDealVersionHandle);
        String[] newDealVersionHandle = {new String()};
        DealerAPIWrapper.submitDraftAmendment(session.getLoginHandle(), oldDealVersionHandle, swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
        System.out.println("Draft amendment submitted OK");
