    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          to make real API calls. Use HTTPS URLs like `https://mw.uat.api.markit.com` for better SSL compatibility. 
          Connection tests show the server is reachable but has SSL certificate issues in this environment. 
          All commands use the real Java wrapper with proper parameter handling.
        </AlertDescription>
      </Alert>
