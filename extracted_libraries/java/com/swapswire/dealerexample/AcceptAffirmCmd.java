...
public class AcceptAffirmCmd extends DealerCmd {

    public AcceptAffirmCmd() {
        super( "AcceptAffirm", "oldDealVersionHandle privateDataXML" );
    }

    public static String run( Session session, String oldDVH, String privateDataXML ) throws ErrorCode {
        System.out.println( "AcceptAffirm - " + oldDVH );
        String[] newDealVersionHandle = { new String() };
        DealerAPIWrapper.acceptAffirm( session.getLoginHandle(), oldDVH, privateDataXML, newDealVersionHandle );
