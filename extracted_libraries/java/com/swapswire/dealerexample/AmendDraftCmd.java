...
public class AmendDraftCmd extends DealerCmd {

    public AmendDraftCmd() {
        super("AmendDraft", "oldDealVersionHandle SWDML privateDataXML recipientXML messageText");
    }
    ...
    public static String run(Session session, String oldDealVersionHandle, String swdml, String privateDataXML, String recipientXML, String messageText) throws ErrorCode {
        System.out.println("Amending draft deal - " + oldDealVersionHandle);
        String[] newDealVersionHandle = {new String()};
        DealerAPIWrapper.amendDraft(session.getLoginHandle(), oldDealVersionHandle, swdml, privateDataXML, recipientXML, messageText, newDealVersionHandle);
        System.out.println("Amendment OK");
