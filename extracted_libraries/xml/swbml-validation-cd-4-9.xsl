...
<xsl:variable name="creditDefaultSwap" select="/fpml:SWBML/fpml:swbStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap | /fpml:SWBML/fpml:swbStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwapOption/fpml:creditDefaultSwap"/>
...
<xsl:if test="$isPrimeBrokerTrade=0 and ($productType = 'CDS' or $productType = 'CDS Index' or $productType = 'CDS Index Swaption' or $productType = 'CDS Master' or $productType = 'CDS Matrix')">
<xsl:choose>
...
<text>*** swbInterDealerTransaction/swbExecutingDealer/@href must be a seller or buyer if product type is 'CDS Index', 'CDS Index Swaption', 'CDS Master' or 'CDS Matrix'. </text>
</error>
</xsl:if>
<xsl:if test="($hrefC != $generalTerms/fpml:buyerPartyReference/@href) and ($hrefC != $generalTerms/fpml:sellerPartyReference/@href)">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** swbCustomerTransaction/swbCustomer/@href must be a buyer or seller if product type is 'CDS Index', 'CDS Index Swaption', 'CDS Master' or 'CDS Matrix'. </text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:if test="swbProductType='CDS on Loans'">
<xsl:call-template name="isValidProductSubType">
<xsl:with-param name="elementName">swbProductSubType</xsl:with-param>
<xsl:with-param name="elementValue">
<xsl:value-of select="fpml:swbProductSubType"/>
</xsl:with-param>
<xsl:with-param name="testNumber"/>
<xsl:with-param name="context">
<xsl:value-of select="$newContext"/>
...
<xsl:if test="fpml:swbProductType='CDS on MBS'">
...
<xsl:with-param name="swbProductSubTypeToCompare">
<xsl:value-of select="fpml:swbProductSubType"/>
</xsl:with-param>
<xsl:with-param name="testNumber"/>
<xsl:with-param name="context">
...
<text>*** Missing swbExtendedTradeDetails/swbProductTerm element. Element must be present if product type is 'CDS'  or 'CDS Master' or 'CDS Matrix'.</text>
</error>
</xsl:if>
...
<text>*** Unexpected number of party child elements encountered. 3 or more expected (<xsl:value-of select="count(fpml:party)"/> found).</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:choose>
<xsl:when test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS Index' or $productType='CDS Master' or $productType='CDS on MBS'">
<xsl:if test="not(fpml:creditDefaultSwap)">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Missing creditDefaultSwap element. Element must be present if product type is 'CDS', 'CDS Index', 'CDS Master' or 'CDS Matrix'.</text>
</error>
</xsl:if>
...
<xsl:if test="fpml:calculationAgent and $productType!='CDS Index' and $productType!='CDS Index Swaption' and $productType!='CDS Matrix' and $productType!='CDS on Loans' and $productType!='CDS on MBS'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:choose>
<xsl:when test="$broker=$generalTerms/fpml:buyerPartyReference/@href">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:when test="$broker=$generalTerms/fpml:sellerPartyReference/@href">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:value-of select="fpml:contractualTermsSupplement"/>
</xsl:variable>
<xsl:variable name="masterConfirmation">
<xsl:value-of select="fpml:masterConfirmation"/>
</xsl:variable>
<xsl:variable name="brokerConfirmation">
<xsl:value-of select="fpml:brokerConfirmation"/>
</xsl:variable>
<xsl:if test="$productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Matrix' or $productType='CDS Master'">
...
<text>*** Unexpected contractualTermsSupplement element in this context.</text>
</error>
</xsl:if>
...
<text>*** A contractualSupplement element containing 'ISDACreditMonolineInsurers' must be present if brokerConfirmationType contains 'NorthAmericaMonolineInsurer'.</text>
</error>
</xsl:if>
</xsl:if>
...
<text>*** A contractualSupplement element containing 'ISDACreditMonolineInsurers' must only be present if brokerConfirmationType contains 'NorthAmericaMonolineInsurer'.</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:call-template name="isValidCDSIndexSwaptionConfirmationType">
<xsl:with-param name="elementName">brokerConfirmationType</xsl:with-param>
<xsl:with-param name="elementValue">
<xsl:value-of select="fpml:brokerConfirmationType"/>
</xsl:with-param>
...
<xsl:if test="fpml:masterAgreementDate and $productType !='CDS Index' and $productType !='CDS Index Swaption'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:if test="fpml:swbTradeHeader/fpml:swbClearingHouse and $productType != 'CDS Index' and $productType != 'CDS Matrix'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** swbTradeHeader/swbClearingHouse is only expected on CDS Index and CDS Matrix trades.</text>
</error>
</xsl:if>
<xsl:if test="fpml:swbTradeHeader/fpml:swbPredeterminedClearerForUnderlyingSwap and $productType != 'CDS Index Swaption'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** swbTradeHeader/swbPredeterminedClearerForUnderlyingSwap is only expected on CDS Index Swaption trades.</text>
</error>
</xsl:if>
...
<xsl:if test="fpml:swbProductTerm and $productType='CDS Index' and $productType='CDS Index Swaption'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Unexpected swbProductTerm element. Element must not be present if product type is 'CDS Index' or 'CDS Index Swaption'.</text>
</error>
</xsl:if>
...
<xsl:if test="not($period='M' or $period='Y')">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** period must be equal to 'M' or 'Y'. Value = '<xsl:value-of select="$period"/>'</text>
</error>
</xsl:if>
...
<xsl:variable name="newContext">
<xsl:value-of select="$context"/>/<xsl:value-of select="local-name()"/>[<xsl:number value="position()"/>]</xsl:variable>
<xsl:if test="fpml:partyReference/@href and ($productType = 'CDS' or $productType = 'CDS Index' or $productType = 'CDS Index Swaption')">
<xsl:choose>
<xsl:when test="fpml:partyReference/@href=$generalTerms/fpml:buyerPartyReference/@href"/>
<xsl:when test="fpml:partyReference/@href=$generalTerms/fpml:sellerPartyReference/@href"/>
<xsl:otherwise>
...
<text>*** Missing referenceInformation element. Element must be present if product type is 'CDS', 'CDS Master' or 'CDS Matrix'.</text>
</error>
</xsl:if>
...
<xsl:if test="fpml:singlePayment and ($productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Master' or 'CDS Matrix')">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Unexpected singlePayment element. Element must not be present if product type is 'CDS Index', 'CDS Index Swaption', 'CDS Master' or 'CDS Matrix', where initialPayment should be used.</text>
</error>
</xsl:if>
...
<text>*** initialPoints must be present if quotationStyle is PointsUpFront.</text>
</error>
</xsl:if>
...
<text>*** marketFixedRate must be present if quotationStyle is TradedSpread.</text>
</error>
</xsl:if>
</xsl:if>
</xsl:if>
...
<xsl:with-param name="elementValue">
<xsl:value-of select="fpml:initialPoints"/>
</xsl:with-param>
...
<text>*** Unexpected adjustablePaymentDate element encountered in this context.</text>
</error>
</xsl:if>
<xsl:if test="fpml:adjustedPaymentDate and $productType != 'CDS on MBS'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:if test="(fpml:firstPaymentDate or fpml:lastRegularPaymentDate or fpml:rollConvention) and ($productType='CDS Index' or $productType='CDS Index Swaption')">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<text>*** paymentFrequency must be equal to 3M or 6M if product type is 'CDS', 'CDS Master' or 'CDS Matrix'. Value = '<xsl:value-of select="$freq"/>'.</text>
</error>
</xsl:otherwise>
</xsl:choose>
</xsl:if>
...
<text>*** Unexpected failureToPayPrincipal element encountered in this context.</text>
</error>
</xsl:if>
...
<text>*** Unexpected failureToPayInterest element encountered in this context.</text>
</error>
</xsl:if>
...
<text>*** Unexpected restructuring element encountered in this context. Restructuring is only valid for brokerConfirmationType 'NorthAmericanCorporate' or  'StandardNorthAmericanCorporate' or 'EmergingEuropeanCorporateLPN'</text>
</error>
</xsl:if>
</xsl:if>
...
<text>*** Unexpected distressedRatingsDowngrade element encountered in this context.</text>
</error>
</xsl:if>
...
<text>*** Unexpected maturityExtension element encountered in this context.</text>
</error>
</xsl:if>
...
<text>*** Unexpected writedown element encountered in this context.</text>
</error>
</xsl:if>
...
($indexIdScheme != 'http://www.fpml.org/coding-scheme/external/standard-and-poors' and $brokerConfirmationType = 'SP')">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:if test="$entityIdScheme != 'http://www.fpml.org/spec/2003/entity-id-RED-1-0' and $productType != 'CDS on MBS'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:if test="string-length(fpml:entityId) != 6 and $productType != 'CDS on MBS'">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<text>*** ISIN or CUSIP instrumentId must be present.</text>
</error>
</xsl:otherwise>
</xsl:choose>
...
<text>*** Unexpected issuerPartyReference element encountered in this context.</text>
</error>
</xsl:if>
...
<xsl:template name="isValidCDSIndexSwaptionConfirmationType">
<xsl:param name="elementName"/>
<xsl:param name="elementValue"/>
<xsl:param name="testNumber"/>
<xsl:param name="context"/>
...
<xsl:when test="$elementValue='ISDAFixedRecovery'"/>
<xsl:when test="$elementValue='ISDARecoveryLock'"/>
<xsl:otherwise>
<error>
<context>
<xsl:value-of select="$context"/>
...
<xsl:variable name="errorText">Empty or invalid <xsl:value-of select="$elementName"/> element. Value = '<xsl:value-of select="$elementValue"/>'.</xsl:variable>
<xsl:choose>
<xsl:when test="$productType='CDS' or $productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Master' ">
<xsl:choose>
...
<xsl:param name="elementName"/>
<xsl:param name="elementValue"/>
<xsl:param name="swbProductSubTypeToCompare"/>
<xsl:param name="testNumber"/>
<xsl:param name="context"/>
<xsl:variable name="errorText">Error for <xsl:value-of select="$elementName"/> and swbProductSubType elements when SWDML version = "<xsl:value-of select="$version"/>". mortgage sector = '<xsl:value-of select="$elementValue"/>' and swbProductSubType ='<xsl:value-of select="$swbProductSubTypeToCompare"/>' are not compatible.</xsl:variable>
<xsl:if test="$version='4-9'">
<xsl:choose>
<xsl:when test="($elementValue='CMBS' or $elementValue='') and $swbProductSubTypeToCompare='CMBS'"/>
<xsl:when test="($elementValue='CMBS' or $elementValue='') and $swbProductSubTypeToCompare='ECMBS'"/>
<xsl:when test="($elementValue='RMBS' or $elementValue='') and $swbProductSubTypeToCompare='RMBS'"/>
<xsl:when test="($elementValue='RMBS' or $elementValue='') and $swbProductSubTypeToCompare='ERMBS'"/>
<xsl:otherwise>
<error>
<context>
<xsl:value-of select="$context"/>
