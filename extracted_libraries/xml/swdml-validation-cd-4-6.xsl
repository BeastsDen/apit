<?xml version="1.0"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fpml="http://www.fpml.org/2009/FpML-4-6" exclude-result-prefixes="fpml common" xmlns:common="http://exslt.org/common" version="1.0">
...
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:protectionTerms/fpml:calculationAmount/fpml:currency"/>
</xsl:variable>
<xsl:variable name="tranche">
<xsl:value-of select="fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:indexReferenceInformation/fpml:tranche"/>
</xsl:variable>
...
<xsl:if test="$productType = 'CDS Index' or $productType = 'CDS Master' or $productType = 'CDS Matrix'">
...
<xsl:if test="($hrefC != //fpml:FpML/fpml:trade//fpml:creditDefaultSwap/fpml:generalTerms/fpml:sellerPartyReference/@href) and ($hrefC != //fpml:FpML/fpml:trade//fpml:creditDefaultSwap/fpml:generalTerms/fpml:buyerPartyReference/@href)">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<text>*** Missing creditDefaultSwap element. Element must be present if product type is 'CDS' or 'CDS Matrix' or 'CDS Index' or 'CDS Master'.</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:if test="$productType='CDS Index' or $productType='CDS Master'">
...
<xsl:with-param name="allocPartyA">
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:sellerPartyReference/@href"/>
</xsl:with-param>
<xsl:with-param name="allocPartyB">
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:buyerPartyReference/@href"/>
</xsl:with-param>
</xsl:apply-templates>
</xsl:template>
<xsl:template match="fpml:paymentDetail">
...
<xsl:if test="($masterAgreement='' or $contractualTermsSupplement ='') and $tranche != ''">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Missing masterAgreement element. Element must be present if product type is 'CDS Index Tranche'.</text>
</error>
</xsl:if>
<xsl:if test="$masterAgreement != '' and $contractualTermsSupplement=''">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Unexpected masterAgreement element or missing contractualTermsSupplement element for product 'CDS Index'.</text>
</error>
</xsl:if>
...
<text>*** Unexpected masterAgreement and masterConfirmation elements for product 'CDS Index'.</text>
</error>
</xsl:if>
...
<text>*** Unexpected masterAgreement, masterConfirmation and contractualTermsSupplement elements present for product 'CDS Index'.</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:if test="$productType='CDS Index'">
<xsl:if test="$masterConfirmation !='' and $tranche !=''">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
...
<xsl:if test="$masterConfirmation !='' and $contractualTermsSupplement !=''">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Unexpected masterConfirmation and contractualTermsSupplement elements for 'CDS Index'.</text>
</error>
</xsl:if>
</xsl:if>
<xsl:if test="($productType='CDS Index' or $productType='CDS Master') and $masterConfirmation !=''">
...
<xsl:if test="$productType='CDS Index' and $contractualTermsSupplement !=''">
...
<xsl:with-param name="elementValue">
<xsl:value-of select="fpml:contractualTermsSupplement/fpml:type"/>
</xsl:with-param>
<xsl:with-param name="testNumber"/>
<xsl:with-param name="context">
<xsl:value-of select="$newContext"/>
...
<text>*** First and second contractualSupplement must equal 'ISDA2003CreditMay2003' and ISDA2003Credit2005MatrixSupplement in that order if product type is 'CDS Matrix'.  Value1 = '<xsl:value-of select="$contractualSupplement1"/>'.  Value2 = '<xsl:value-of select="$contractualSupplement2"/>'.</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:if test="$productType = 'CDS' or $productType = 'CDS Index' or $productType='CDS Master'">
<xsl:choose>
<xsl:when test="fpml:partyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:buyerPartyReference/@href"/>
<xsl:when test="fpml:partyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:sellerPartyReference/@href"/>
<xsl:otherwise>
<error>
<context>
<xsl:value-of select="$newContext"/>
...
<text>*** Unexpected cashSettlementTerms element encountered in this context.</text>
</error>
</xsl:if>
</xsl:template>
...
<xsl:if test="$productType = 'CDS Index' or $productType = 'CDS Master' or $productType = 'CDS Matrix'">
<xsl:if test="fpml:additionalTerm != '' ">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Additional Term not supported in version SWDML 4.6 .</text>
</error>
</xsl:if>
</xsl:if>
...
<text>*** Missing indexReferenceInformation element. Element must be present if product type is 'CDS Index'.</text>
</error>
</xsl:if>
...
<xsl:if test="fpml:singlePayment and ($productType='CDS Index' or $productType='CDS Master' or $productType='CDS Matrix')">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** Unexpected singlePayment element. Element must not be present if product type is 'CDS Index' or 'CDS Master'.</text>
</error>
</xsl:if>
...
<xsl:choose>
<xsl:when test="fpml:payerPartyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:buyerPartyReference/@href"/>
<xsl:when test="fpml:payerPartyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:sellerPartyReference/@href"/>
<xsl:otherwise>
<error>
<context>
<xsl:value-of select="$newContext"/>
...
<xsl:if test="$productType='CDS' or $productType='CDS Index' or $productType='CDS Master' or $productType='CDS Matrix'">
<xsl:choose>
<xsl:when test="fpml:receiverPartyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:buyerPartyReference/@href"/>
<xsl:when test="fpml:receiverPartyReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:sellerPartyReference/@href"/>
<xsl:otherwise>
<error>
<context>
<xsl:value-of select="$newContext"/>
...
<text>*** fixedAmount/currency must equal //FpML/trade/creditDefaultSwap/protectionTerms/calculationAmount/currency.</text>
</error>
</xsl:if>
...
<text>*** Unexpected firstPaymentDate, lastRegularPaymentDate or rollConvention element. Elements must not be present if product type is 'CDS Index'.</text>
</error>
</xsl:if>
...
<text>*** Unexpected creditEvents element. Element must not be present if product type is 'CDS Index'.</text>
</error>
</xsl:if>
...
<xsl:if test="not(fpml:primaryObligorReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:referenceInformation/fpml:referenceEntity/@id)">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** primaryObligorReference/@href must equal //FpML/trade/creditDefaultSwap/generalTerms/referenceInformation/referenceEntity/@id.</text>
</error>
</xsl:if>
</xsl:if>
<xsl:if test="fpml:guarantorReference">
<xsl:if test="not(fpml:guarantorReference/@href=/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:referenceInformation/fpml:referenceEntity/@id)">
<error>
<context>
<xsl:value-of select="$newContext"/>
</context>
<text>*** guarantorReference/@href must equal //FpML/trade/creditDefaultSwap/generalTerms/referenceInformation/referenceEntity/@id.</text>
</error>
</xsl:if>
</xsl:if>
...
<xsl:variable name="attachmentPoint">
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:indexReferenceInformation/fpml:tranche/fpml:attachmentPoint"/>
</xsl:variable>
<xsl:variable name="exhaustionPoint">
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:generalTerms/fpml:indexReferenceInformation/fpml:tranche/fpml:exhaustionPoint"/>
</xsl:variable>
<xsl:variable name="fixedRate">
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:feeLeg/fpml:periodicPayment/fpml:fixedAmountCalculation/fpml:fixedRate"/>
</xsl:variable>
...
<xsl:otherwise>
<error>
<context>In /SWDML/swLongFormTrade/swStructuredTradeDetails/FpML/trade/creditDefaultSwap/generalTerms/indexReferenceInformation/tranche</context>
...
<xsl:otherwise>
<error>
<context>In /SWDML/swLongFormTrade/swStructuredTradeDetails/FpML/trade/creditDefaultSwap/feeLeg/periodicPayment/fixedAmountCalculation/fixedRate</context>
