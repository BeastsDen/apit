...
<primeBrokerA><xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swGiveUp/fpml:swInterDealerTransaction/fpml:swPrimeBroker/@href"/></primeBrokerA>
<primeBrokerB><xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swGiveUp/fpml:swCustomerTransaction/fpml:swPrimeBroker/@href"/></primeBrokerB>
</partyRoles>
...
<xsl:variable name="swLongFormTrade" select="/fpml:SWDML/fpml:swLongFormTrade"/>
<xsl:variable name="ReplacementTradeId" select="$swLongFormTrade/fpml:swReplacementTradeId"/>
<xsl:variable name="swShortFormTrade" select="/fpml:SWDML/fpml:swShortFormTrade"/>
<xsl:variable name="swStructuredTradeDetails" select="$swLongFormTrade/fpml:swStructuredTradeDetails"/>
<xsl:variable name="productType" select="$swStructuredTradeDetails/fpml:swProductType"/>
<xsl:variable name="productSubType" select="$swStructuredTradeDetails/fpml:swProductSubType"/>
...
<xsl:variable name="tradeHeader" select="$trade/fpml:tradeHeader"/>
<xsl:variable name="documentation" select="$trade/fpml:documentation"/>
<xsl:variable name="contractualTermsSupplementForSwaption" select="$documentation/fpml:contractualTermsSupplement[fpml:type/@contractualSupplementScheme='http://www.fpml.org/ext/swaption-supplement']"/>
<xsl:variable name="contractualTermsSupplement" select="$documentation/fpml:contractualTermsSupplement[fpml:type/@contractualSupplementScheme='http://www.fpml.org/coding-scheme/contractual-supplement']"/>
<xsl:variable name="swCreditDefaultSwapDetails" select="$swExtendedTradeDetails/fpml:swCreditDefaultSwapDetails"/>
<xsl:variable name="swCreditDefaultSwapAmendment" select="$swCreditDefaultSwapDetails/fpml:swCreditDefaultSwapAmendment"/>
...
<xsl:variable name="feeLeg" select="$creditDefaultSwap/fpml:feeLeg"/>
...
<xsl:variable name="cashSettlementTerms" select="$creditDefaultSwap/fpml:cashSettlementTerms"/>
<xsl:variable name="periodicPayment" select="$feeLeg/fpml:periodicPayment"/>
<xsl:variable name="indexReferenceInformation" select="$generalTerms/fpml:indexReferenceInformation"/>
<xsl:variable name="effectiveDate" select="$generalTerms/fpml:effectiveDate"/>
<xsl:variable name="referenceInformation" select="$generalTerms/fpml:referenceInformation"/>
<xsl:variable name="floatingAmountEvents" select="$protectionTerms/fpml:floatingAmountEvents"/>
<xsl:variable name="referenceObligation" select="$referenceInformation/fpml:referenceObligation"/>
<xsl:variable name="bond" select="$referenceObligation/fpml:bond"/>
<xsl:variable name="loan" select="$referenceObligation/fpml:loan"/>
<xsl:variable name="mortgage" select="$referenceObligation/fpml:mortgage"/>
<xsl:variable name="underlyer" select="$bond | $loan | $mortgage"/>
<xsl:variable name="underlyerInstrumentId" select="$underlyer/fpml:instrumentId"/>
<xsl:variable name="isStructuredIndice">
<xsl:variable name="indexType" select="$documentation/fpml:contractualTermsSupplement/fpml:type"/>
<xsl:choose>
...
<xsl:choose>
<xsl:when test="$swLongFormTrade/fpml:novation">
...
<xsl:value-of select="$tradeHeader/fpml:partyTradeIdentifier/fpml:partyReference/@href[. != $partyA]"/>
</xsl:when>
<xsl:when test="$swLongFormTrade/fpml:novation">
...
<xsl:choose>
<xsl:when test="$swLongFormTrade//fpml:swGiveUp">
<xsl:choose>
<xsl:when test="starts-with(/fpml:SWDML//fpml:swInterDealerTransaction/fpml:swPrimeBroker/@href,'#')">
<xsl:value-of select="substring-after(/fpml:SWDML//fpml:swInterDealerTransaction/fpml:swPrimeBroker/@href,'#')"/>
</xsl:when>
<xsl:otherwise>
...
<xsl:when test="$swLongFormTrade//fpml:swGiveUp">
<xsl:choose>
<xsl:when test="starts-with(/fpml:SWDML//fpml:swCustomerTransaction/fpml:swPrimeBroker/@href,'#')">
<xsl:value-of select="substring-after(/fpml:SWDML/fpml:swCustomerTransaction/fpml:swPrimeBroker/@href,'#')"/>
</xsl:when>
<xsl:otherwise>
...
<xsl:if test="$swLongFormTrade//fpml:swGiveUp">
<xsl:choose>
<xsl:when test="starts-with(/fpml:SWDML//fpml:swExecutingDealerCustomerTransaction/fpml:swExecutingDealer/@href,'#')">
<xsl:value-of select="substring-after(/fpml:SWDML/fpml:swExecutingDealerCustomerTransaction/fpml:swExecutingDealer/@href,'#')"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="/fpml:SWDML//fpml:swExecutingDealerCustomerTransaction/fpml:swExecutingDealer/@href"/>
</xsl:otherwise>
</xsl:choose>
</xsl:if>
</xsl:variable>
...
<AllocatedTrade>
<xsl:value-of select="boolean($swLongFormTrade/fpml:swAllocations)"/>
</AllocatedTrade>
<xsl:if test="$swLongFormTrade//fpml:swAllocations">
<xsl:call-template name="fpml:swAllocations"/>
</xsl:if>
<PrimeBrokerTrade>
<xsl:value-of select="boolean($swLongFormTrade/fpml:swGiveUp)"/>
</PrimeBrokerTrade>
<ReversePrimeBrokerLegalEntities>
<xsl:if test="$swLongFormTrade//fpml:swGiveUp">
<xsl:choose>
<xsl:when test="starts-with(/fpml:SWDML//fpml:swCustomerTransaction/fpml:swCustomer/@href,'#')">
<xsl:value-of select="boolean(/fpml:SWDML//fpml:swCustomerTransaction/fpml:swCustomer/@href = $partyA)"/>
</xsl:when>
<xsl:otherwise>
<xsl:value-of select="boolean(string(/fpml:SWDML//fpml:swCustomerTransaction/fpml:swCustomer/@href) = $partyA)"/>
</xsl:otherwise>
</xsl:choose>
</xsl:if>
</ReversePrimeBrokerLegalEntities>
<PartyAId>
<xsl:if test="$swLongFormTrade//fpml:swGiveUp or $swLongFormTrade//fpml:novation">
<xsl:attribute name="id">
<xsl:value-of select="$partyA"/>
</xsl:attribute>
</xsl:if>
<xsl:value-of select="$party[@id=$partyA]/fpml:partyId"/>
</PartyAId>
<PartyAIdType>
<xsl:value-of select="$party[@id=$partyA]/fpml:partyId/@partyIdScheme"/>
</PartyAIdType>
<PartyBId>
<xsl:if test="$swLongFormTrade//fpml:swGiveUp or $swLongFormTrade//fpml:novation">
<xsl:attribute name="id">
...
<xsl:value-of select="$party[@id=$partyB]/fpml:partyId"/>
</PartyBId>
<PartyBIdType>
<xsl:value-of select="$party[@id=$partyB]/fpml:partyId/@partyIdScheme"/>
</PartyBIdType>
<PartyCId>
<xsl:if test="$swLongFormTrade//fpml:swGiveUp or $swLongFormTrade//fpml:novation">
<xsl:attribute name="id">
...
<DirectionA>
<xsl:choose>
<xsl:when test="$generalTerms/fpml:buyerPartyReference/@href = $partyA">Buy</xsl:when>
<xsl:otherwise>Sell</xsl:otherwise>
</xsl:choose>
</DirectionA>
<TradeDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$tradeHeader/fpml:tradeDate"/>
</xsl:call-template>
</TradeDate>
<StartDateTenor/>
<EndDateTenor/>
...
<Tenor>
<xsl:choose>
<xsl:when test="($productType='CDS Index' or $productType='CDS Index Swaption') and not($effectiveDate/fpml:unadjustedDate)">5Y</xsl:when>
<xsl:when test="($productType='CDS Index' or $productType='CDS Index Swaption') and $effectiveDate/fpml:unadjustedDate">
<xsl:variable name="effDateYear" select="substring($effectiveDate/fpml:unadjustedDate, 1, 4)"/>
<xsl:variable name="termDateYear" select="substring($generalTerms/fpml:scheduledTerminationDate/fpml:adjustableDate/fpml:unadjustedDate, 1, 4)"/>
<xsl:variable name="effDateMonth" select="substring($effectiveDate/fpml:unadjustedDate, 6, 2)"/>
<xsl:variable name="termDateMonth" select="substring($generalTerms/fpml:scheduledTerminationDate/fpml:adjustableDate/fpml:unadjustedDate, 6, 2)"/>
...
<StartDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$effectiveDate/fpml:unadjustedDate"/>
</xsl:call-template>
</StartDate>
...
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$generalTerms/fpml:scheduledTerminationDate/fpml:adjustableDate/fpml:unadjustedDate"/>
</xsl:call-template>
</xsl:variable>
...
<xsl:for-each select="$periodicPayment/fpml:paymentFrequency">
...
<FloatRollFreq_2/>
<RollsType>
<xsl:if test="$productType='CDS' or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:variable name="rollConvention" select="$periodicPayment/fpml:rollConvention"/>
...
<xsl:variable name="termDateMMDD" select="substring($generalTerms/fpml:scheduledTerminationDate/fpml:adjustableDate/fpml:unadjustedDate,6,5)"/>
<xsl:choose>
<xsl:when test="(($rollConvention='20' or not($rollConvention)) and ($termDateMMDD='03-20' or $termDateMMDD='06-20' or $termDateMMDD='09-20' or $termDateMMDD='12-20') and not($periodicPayment/fpml:lastRegularPaymentDate)) or not($periodicPayment)">Standard</xsl:when>
<xsl:otherwise>Custom</xsl:otherwise>
</xsl:choose>
</xsl:if>
</RollsType>
...
<RollDay>
<xsl:if test="$productType='CDS' or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:value-of select="$periodicPayment/fpml:rollConvention"/>
</xsl:if>
<xsl:if test="$productType='CDS Matrix'">
<xsl:choose>
<xsl:when test="$creditDefaultSwap/fpml:feeLeg/fpml:periodicPayment/fpml:rollConvention">
...
<xsl:variable name="rollConvention" select="$periodicPayment/fpml:rollConvention"/>
<xsl:value-of select="boolean($rollConvention='EOM')"/>
</xsl:if>
</MonthEndRolls>
<FirstPeriodStartDate>
<xsl:if test="($productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master' or $productType='CDS on MBS') and $periodicPayment/fpml:firstPeriodStartDate">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$periodicPayment/fpml:firstPeriodStartDate"/>
</xsl:call-template>
</xsl:if>
</FirstPeriodStartDate>
<FirstPaymentDate>
<xsl:if test="($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master' or $productType='CDS on MBS') and $periodicPayment/fpml:firstPaymentDate">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$periodicPayment/fpml:firstPaymentDate"/>
</xsl:call-template>
</xsl:if>
</FirstPaymentDate>
<LastRegularPaymentDate>
<xsl:if test="($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master') and $periodicPayment/fpml:lastRegularPaymentDate">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$periodicPayment/fpml:lastRegularPaymentDate"/>
</xsl:call-template>
</xsl:if>
</LastRegularPaymentDate>
<FixedRate>
<xsl:value-of select="$periodicPayment/fpml:fixedAmountCalculation/fpml:fixedRate"/>
</FixedRate>
<FixedRate_2/>
<initialPoints>
<xsl:if test="$productType='CDS Matrix' or $productType='CDS Master'">
<xsl:value-of select="$feeLeg/fpml:initialPoints"/>
</xsl:if>
</initialPoints>
<quotationStyle>
<xsl:if test="$productType='CDS Matrix' or $productType='CDS Master'">
<xsl:value-of select="$feeLeg/fpml:quotationStyle"/>
</xsl:if>
</quotationStyle>
<RecoveryRate>
<xsl:if test="$productType='CDS Matrix'">
<xsl:value-of select="$cashSettlementTerms/fpml:recoveryFactor"/>
</xsl:if>
</RecoveryRate>
<FixedSettlement>
<xsl:if test="$productType='CDS Matrix'">
<xsl:value-of select="$cashSettlementTerms/fpml:fixedSettlement"/>
</xsl:if>
</FixedSettlement>
<Currency>
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Master' or $productType='CDS on MBS'">
<xsl:value-of select="$protectionTerms/fpml:calculationAmount/fpml:currency"/>
</xsl:if>
</Currency>
<Currency_2/>
<Notional>
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Master' or $productType='CDS on MBS'">
<xsl:value-of select="$protectionTerms/fpml:calculationAmount/fpml:amount"/>
</xsl:if>
</Notional>
<Notional_2/>
<InitialNotional/>
...
<xsl:if test="$productType='CDS' or $productType='CDS Matrix'  or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:choose>
<xsl:when test="$periodicPayment/fpml:lastRegularPaymentDate">End</xsl:when>
...
<CBClearedTimestamp>
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade//fpml:swStructuredTradeDetails/fpml:swExtendedTradeDetails/fpml:swTradeHeader/fpml:swCBClearedTimestamp"/>
</CBClearedTimestamp>
<CBTradeType>
<xsl:value-of select="/fpml:SWDML/fpml:swLongFormTrade//fpml:swStructuredTradeDetails/fpml:swExtendedTradeDetails/fpml:swTradeHeader/fpml:swCBTradeType"/>
</CBTradeType>
...
<OriginatingTradeId>
<xsl:value-of select="$swTradeHeader/fpml:swOriginatingTradeId"/>
</OriginatingTradeId>
</xsl:if>
<ESMAFrontloading>
...
<xsl:variable name="tradeNotional" select="$protectionTerms/fpml:calculationAmount/fpml:amount"/>
<xsl:variable name="novatedAmount">
<xsl:choose>
<xsl:when test="$swLongFormTrade/fpml:novation/fpml:novatedAmount/fpml:amount">
<xsl:value-of select="$swLongFormTrade/fpml:novation/fpml:novatedAmount/fpml:amount"/>
</xsl:when>
<xsl:otherwise>
...
<PartialNovation>
<xsl:if test="$swLongFormTrade//fpml:novation/fpml:swPartialNovationIndicator">
<xsl:value-of select="boolean($swLongFormTrade//fpml:novation/fpml:swPartialNovationIndicator = 'true')"/>
</xsl:if>
</PartialNovation>
<FourWayNovation>
<xsl:choose>
<xsl:when test="$swLongFormTrade//fpml:novation">
<xsl:value-of select="boolean($swLongFormTrade//fpml:novation/fpml:otherRemainingParty)"/>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
</FourWayNovation>
...
<xsl:when test="$swLongFormTrade//fpml:novation">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$swLongFormTrade//fpml:novation/fpml:novationTradeDate"/>
</xsl:call-template>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
...
<xsl:when test="$swLongFormTrade//fpml:novation">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$swLongFormTrade//fpml:novation/fpml:novationDate"/>
</xsl:call-template>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
...
<xsl:value-of select="$swLongFormTrade//fpml:novation/fpml:fullFirstCalculationPeriod"/>
</FullFirstCalculationPeriod>
<NonReliance>
<xsl:if test="$swLongFormTrade//fpml:novation">
<xsl:value-of select="boolean($swLongFormTrade//fpml:novation/fpml:nonReliance)"/>
</xsl:if>
</NonReliance>
<PreserveEarlyTerminationProvision/>
<CopyPremiumToNewTrade/>
<IntendedClearingHouse>
<xsl:if test="$productType='CDS Index' or $productType='CDS Matrix' or $productType='CDS Index Swaption'">
<xsl:value-of select="$swTradeHeader/fpml:swClearingHouse/fpml:partyId"/>
</xsl:if>
</IntendedClearingHouse>
<xsl:if test="$swLongFormTrade and ($productType='CDS Index' or $productType='CDS Index Swaption')">
<xsl:apply-templates select="$swExtendedTradeDetails/fpml:additionalPayment"/>
</xsl:if>
<xsl:if test="$swLongFormTrade/fpml:novation/fpml:payment">
<xsl:apply-templates select="$swLongFormTrade/fpml:novation/fpml:payment"/>
</xsl:if>
<OptionStyle>
...
<xsl:value-of select="$europeanExercise/fpml:expirationDate/fpml:adjustableDate/fpml:dateAdjustments/fpml:businessDayConvention"/>
</OptionExpirationDateConvention>
...
<xsl:value-of select="$europeanExercise/fpml:earliestExerciseTime/fpml:businessCenter"/>
</OptionEarliestTimeHolidayCentre>
<OptionExpiryTime>
<xsl:value-of select="$europeanExercise/fpml:expirationTime/fpml:hourMinuteTime"/>
</OptionExpiryTime>
<OptionExpiryTimeHolidayCentre>
<xsl:value-of select="$europeanExercise/fpml:expirationTime/fpml:businessCenter"/>
</OptionExpiryTimeHolidayCentre>
...
<xsl:variable name="swClearingTakeup" select="/fpml:SWDML/fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:swExtendedTradeDetails/fpml:swTradeHeader/fpml:swClearingTakeup"/>
...
<xsl:choose>
<xsl:when test="$documentation/fpml:masterConfirmation/fpml:masterConfirmationType">
<xsl:value-of select="$documentation/fpml:masterConfirmation/fpml:masterConfirmationType"/>
</xsl:when>
<xsl:when test="$contractualTermsSupplement/fpml:type">
...
<xsl:variable name="docsType" select="string($documentation/fpml:masterConfirmation/fpml:masterConfirmationType)"/>
<xsl:choose>
<xsl:when test="$docsType='ISDA2003StandardCreditNorthAmerican'">Standard North American Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditNorthAmerican'">North American Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditEuropean'">European Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003StandardCreditEuropean'">Standard European Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditAustraliaNewZealand'">Australia and New Zealand Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003StandardCreditAustraliaNewZealand'">Standard Australia and New Zealand Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditJapan'">Japan Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003StandardCreditJapan'">Standard Japan Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditSingapore'">Singapore Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003StandardCreditSingapore'">Standard Singapore Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003CreditAsia'">Asia Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2003StandardCreditAsia'">Standard Asia Corporate</xsl:when>
<xsl:when test="$docsType='ISDA2004CreditSovereignAsia'">Asia Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004StandardCreditSovereignAsia'">Standard Asia Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004CreditSovereignEmergingEuropeanAndMiddleEastern'">Emerging European and Middle Eastern Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004StandardCreditSovereignEmergingEuropeanAndMiddleEastern'">Standard Emerging European and Middle Eastern Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004CreditSovereignJapan'">Japan Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004StandardCreditSovereignJapan'">Standard Japan Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004CreditSovereignLatinAmerican'">Latin America Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004StandardCreditSovereignLatinAmerican'">Standard Latin America Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004CreditSovereignWesternEuropean'">Western European Sovereign</xsl:when>
<xsl:when test="$docsType='ISDA2004StandardCreditSovereignWesternEuropean'">Standard Western European Sovereign</xsl:when>
...
<xsl:when test="$docsType='2014CreditAsia'">Asia Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAsia'">Standard Asia Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditAsiaFinancial'">Asia Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAsiaFinancial'">Standard Asia Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignAsia'">Asia Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignAsia'">Standard Asia Sovereign</xsl:when>
<xsl:when test="$docsType='2014CreditAustraliaNewZealand'">Australia and New Zealand Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAustraliaNewZealand'">Standard Australia and New Zealand Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditAustraliaNewZealandFinancial'">Australia and New Zealand Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAustraliaNewZealandFinancial'">Standard Australia and New Zealand Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignEmergingEuropeanAndMiddleEastern'">Emerging European and Middle Eastern Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignEmergingEuropeanAndMiddleEastern'">Standard Emerging European and Middle Eastern Sovereign</xsl:when>
<xsl:when test="$docsType='2014CreditEuropean'">European Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropean'">Standard European Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditEuropeanFinancial'">European Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropeanFinancial'">Standard European Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditJapan'">Japan Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditJapan'">Standard Japan Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditJapanFinancial'">Japan Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditJapanFinancial'">Standard Japan Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignJapan'">Japan Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignJapan'">Standard Japan Sovereign</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignLatinAmerican'">Latin America Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignLatinAmerican'">Standard Latin America Sovereign</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignWesternEuropean'">Western European Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignWesternEuropean'">Standard Western European Sovereign</xsl:when>
<xsl:when test="$docsType='2014StandardCreditNorthAmerican'">Standard North American Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditNorthAmerican'">North American Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditNorthAmericanFinancial'">Standard North American Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditNorthAmericanFinancial'">North American Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditSingapore'">Singapore Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSingapore'">Standard Singapore Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditSingaporeFinancial'">Singapore Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSingaporeFinancial'">Standard Singapore Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014CreditEuropeanCoCoFinancial'">European CoCo Financial Corporate</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropeanCoCoFinancial'">Standard European CoCo Financial Corporate</xsl:when>
<xsl:otherwise>
...
<xsl:if test="$productType='CDS Matrix'">
<xsl:variable name="docsType" select="string($documentation/fpml:contractualMatrix/fpml:matrixTerm)"/>
<xsl:choose>
...
<xsl:variable name="docsType" select="string($documentation/fpml:masterConfirmation/fpml:masterConfirmationType)"/>
<xsl:choose>
<xsl:when test="$docsType='2014CreditAsia'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAsia'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditAsiaFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAsiaFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignAsia'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignAsia'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditAustraliaNewZealand'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAustraliaNewZealand'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditAustraliaNewZealandFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditAustraliaNewZealandFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignEmergingEuropeanAndMiddleEastern'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignEmergingEuropeanAndMiddleEastern'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditEuropean'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropean'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditEuropeanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropeanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditJapan'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditJapan'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditJapanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditJapanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignJapan'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignJapan'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignLatinAmerican'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignLatinAmerican'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSovereignWesternEuropean'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSovereignWesternEuropean'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditNorthAmerican'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditNorthAmerican'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditNorthAmericanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditNorthAmericanFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSingapore'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSingapore'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditSingaporeFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditSingaporeFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014CreditEuropeanCoCoFinancial'">ISDA2014Credit</xsl:when>
<xsl:when test="$docsType='2014StandardCreditEuropeanCoCoFinancial'">ISDA2014Credit</xsl:when>
</xsl:choose>
</xsl:if>
</xsl:otherwise>
</xsl:choose>
...
<xsl:value-of select="boolean($protectionTerms/fpml:creditEvents/fpml:restructuring)"/>
</xsl:if>
</RestructuringCreditEvent>
...
<RefEntName>
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS on MBS' or $productType='CDS Master'">
<xsl:value-of select="$referenceInformation/fpml:referenceEntity/fpml:entityName"/>
</xsl:if>
</RefEntName>
<RefEntStdId>
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:variable name="entityCLIP" select="string($referenceInformation/fpml:referenceEntity/fpml:entityId)"/>
<xsl:value-of select="translate($entityCLIP,'abcdefghijklmnopqrstuvwxyz','ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
</xsl:if>
</RefEntStdId>
<REROPairStdId>
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:variable name="pairCLIP" select="string($bond/fpml:instrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2003/instrument-id-RED-pair-1-0'])"/>
...
<xsl:if test="$productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master'">
<xsl:choose>
<xsl:when test="$referenceObligation/fpml:primaryObligorReference">I</xsl:when>
<xsl:when test="$referenceObligation/fpml:guarantorReference">G</xsl:when>
<xsl:otherwise/>
</xsl:choose>
</xsl:if>
</RefOblRERole>
<xsl:variable name="isin" select="$underlyerInstrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-ISIN-1-0']"/>
<xsl:variable name="cusip" select="$underlyerInstrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-CUSIP-1-0']"/>
<RefOblSecurityIdType>
<xsl:if test="$referenceObligation and ($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master' or $productType='CDS on MBS')">
<xsl:choose>
<xsl:when test="$isin">ISIN</xsl:when>
<xsl:when test="$cusip">CUSIP</xsl:when>
</xsl:choose>
</xsl:if>
</RefOblSecurityIdType>
<RefOblSecurityId>
<xsl:if test="$referenceObligation">
<xsl:choose>
<xsl:when test="$isin">
...
<BloombergID>
<xsl:choose>
<xsl:when test="$underlyerInstrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-Bloomberg']">
<xsl:value-of select="$underlyerInstrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-Bloomberg']"/>
</xsl:when>
<xsl:when test="$referenceInformation/fpml:referenceEntity/fpml:entityId[@entityIdScheme='http://www.fpml.org/spec/2003/entity-id-Bloomberg']">
<xsl:value-of select="$referenceInformation/fpml:referenceEntity/fpml:entityId[@entityIdScheme='http://www.fpml.org/spec/2003/entity-id-Bloomberg']"/>
</xsl:when>
<xsl:when test="$referenceObligation and $productType='CDS on Loans' and $referenceObligation/fpml:loan/fpml:instrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-Bloomberg-1-0']">
<xsl:value-of select="$referenceObligation/fpml:loan/fpml:instrumentId[@instrumentIdScheme='http://www.fpml.org/spec/2002/instrument-id-Bloomberg-1-0']"/>
</xsl:when>
</xsl:choose>
</BloombergID>
<RefOblMaturity>
<xsl:if test="$referenceObligation and ($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or$productType='CDS Master')">
<xsl:choose>
<xsl:when test="$bond/fpml:maturity">
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$bond/fpml:maturity"/>
</xsl:call-template>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
...
<RefOblCoupon>
<xsl:if test="($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master') and $referenceObligation">
<xsl:value-of select="$bond/fpml:couponRate"/>
</xsl:if>
</RefOblCoupon>
<RefOblPrimaryObligor>
<xsl:if test="($productType='CDS' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Master') and $referenceObligation">
<xsl:value-of select="$referenceObligation/fpml:primaryObligor/fpml:entityName"/>
</xsl:if>
</RefOblPrimaryObligor>
<BorrowerNames>
<xsl:for-each select="$loan/fpml:borrower">
<xsl:value-of select="fpml:entityName"/>
<xsl:if test="position()!=count(../fpml:borrower)">;</xsl:if>
</xsl:for-each>
</BorrowerNames>
<FacilityType>
<xsl:value-of select="$loan/fpml:facilityType"/>
</FacilityType>
<CreditAgreementDate>
<xsl:value-of select="$loan/fpml:creditAgreementDate"/>
</CreditAgreementDate>
<IsSecuredList>
<xsl:value-of select="$referenceInformation/fpml:securedList"/>
</IsSecuredList>
<CashSettlementOnly>
<xsl:choose>
<xsl:when test="//fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:protectionTerms/fpml:obligations/fpml:cashSettlementOnly">true</xsl:when>
<xsl:otherwise>false</xsl:otherwise>
</xsl:choose>
</CashSettlementOnly>
<Continuity>
<xsl:choose>
<xsl:when test="//fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:protectionTerms/fpml:obligations/fpml:continuity">true</xsl:when>
<xsl:otherwise>false</xsl:otherwise>
</xsl:choose>
</Continuity>
<DeliveryOfCommitments>
<xsl:choose>
<xsl:when test="//fpml:FpML/fpml:trade/fpml:creditDefaultSwap/fpml:protectionTerms/fpml:obligations/fpml:deliveryOfCommitments">true</xsl:when>
<xsl:otherwise>false</xsl:otherwise>
</xsl:choose>
</DeliveryOfCommitments>
<ObligationCategory>
<xsl:value-of select="$protectionTerms/fpml:obligations/fpml:category"/>
</ObligationCategory>
<DesignatedPriority>
<xsl:value-of select="$protectionTerms/fpml:obligations/fpml:designatedPriority"/>
</DesignatedPriority>
<LegalFinalMaturity>
...
<ReferencePrice>
<xsl:value-of select="$referenceInformation/fpml:referencePrice"/>
</ReferencePrice>
<ReferencePolicy>
<xsl:value-of select="boolean($referenceInformation/fpml:referencePolicy)"/>
</ReferencePolicy>
<PaymentDelay>
<xsl:value-of select="$feeLeg/fpml:paymentDelay"/>
</PaymentDelay>
<StepUpProvision>
<xsl:value-of select="boolean($floatingAmountEvents/fpml:floatingAmountProvisions/fpml:stepUpProvision)"/>
</StepUpProvision>
<WACCapInterestProvision>
<xsl:value-of select="boolean($floatingAmountEvents/fpml:floatingAmountProvisions/fpml:WACCapInterestProvision)"/>
</WACCapInterestProvision>
<InterestShortfallCapIndicator>
<xsl:value-of select="boolean($floatingAmountEvents/fpml:interestShortfall)"/>
</InterestShortfallCapIndicator>
<InterestShortfallCompounding>
<xsl:value-of select="$floatingAmountEvents/fpml:interestShortfall/fpml:compounding"/>
</InterestShortfallCompounding>
<InterestShortfallCapBasis>
<xsl:value-of select="$floatingAmountEvents/fpml:interestShortfall/fpml:interestShortfallCap"/>
</InterestShortfallCapBasis>
<InterestShortfallRateSource>
<xsl:value-of select="$floatingAmountEvents/fpml:interestShortfall/fpml:rateSource"/>
</InterestShortfallRateSource>
<MortgagePaymentFrequency>
<xsl:value-of select="$mortgage/fpml:paymentFrequency/fpml:periodMultiplier"/>
<xsl:value-of select="$mortgage/fpml:paymentFrequency/fpml:period"/>
</MortgagePaymentFrequency>
<MortgageFinalMaturity>
<xsl:value-of select="$mortgage/fpml:maturity"/>
</MortgageFinalMaturity>
<MortgageOriginalAmount>
<xsl:value-of select="$mortgage/fpml:originalPrincipalAmount"/>
</MortgageOriginalAmount>
<MortgageInitialFactor>
<xsl:value-of select="$mortgage/fpml:pool/fpml:initialFactor"/>
</MortgageInitialFactor>
<MortgageSector>
<xsl:value-of select="$mortgage/fpml:sector"/>
</MortgageSector>
<MortgageInsurer>
<xsl:value-of select="$mortgage/fpml:insurer/fpml:entityName"/>
</MortgageInsurer>
<IndexName>
<xsl:value-of select="$indexReferenceInformation/fpml:indexName"/>
</IndexName>
<IndexId>
<xsl:value-of select="$indexReferenceInformation/fpml:indexId"/>
</IndexId>
<IndexAnnexDate>
<xsl:value-of select="$indexReferenceInformation/fpml:indexAnnexDate"/>
</IndexAnnexDate>
<IndexTradedRate>
<xsl:if test="$productType='CDS Matrix' or $productType='CDS Index' or $productType='CDS Index Swaption' or $productType='CDS Master'">
<xsl:value-of select="$feeLeg/fpml:marketFixedRate"/>
</xsl:if>
</IndexTradedRate>
<UpfrontFee>
<xsl:choose>
...
<xsl:otherwise>
<xsl:value-of select="boolean($feeLeg/fpml:initialPayment)"/>
</xsl:otherwise>
</xsl:choose>
</UpfrontFee>
<UpfrontFeeAmount>
...
<xsl:otherwise>
<xsl:value-of select="$feeLeg/fpml:initialPayment/fpml:paymentAmount/fpml:amount"/>
</xsl:otherwise>
</xsl:choose>
</UpfrontFeeAmount>
<UpfrontFeeCurrency>
...
<xsl:otherwise>
<xsl:value-of select="$feeLeg/fpml:initialPayment/fpml:paymentAmount/fpml:currency"/>
</xsl:otherwise>
</xsl:choose>
</UpfrontFeeCurrency>
<UpfrontFeeDate>
<xsl:for-each select="$feeLeg/fpml:initialPayment/fpml:adjustablePaymentDate[$productType='CDS Master' or $productType='CDS Matrix' or $productType='CDS on Loans' or $productType='CDS Index' or $productType='CDS on MBS'] | $creditDefaultSwapOption/fpml:premium/fpml:paymentDate/fpml:adjustableDate/fpml:unadjustedDate[$productType='CDS Index Swaption']">
<xsl:call-template name="formatDate"/>
</xsl:for-each>
</UpfrontFeeDate>
<UpfrontFeePayer>
<xsl:if test="$creditDefaultSwapOption/fpml:premium or $feeLeg/fpml:initialPayment">
<xsl:variable name="fee" select="$creditDefaultSwapOption/fpml:premium | $feeLeg/fpml:initialPayment"/>
...
<AttachmentPoint>
<xsl:value-of select="$indexReferenceInformation/fpml:tranche/fpml:attachmentPoint"/>
</AttachmentPoint>
<ExhaustionPoint>
<xsl:value-of select="$indexReferenceInformation/fpml:tranche/fpml:exhaustionPoint"/>
</ExhaustionPoint>
<PublicationDate>
<xsl:value-of select="$contractualTermsSupplement/fpml:publicationDate"/>
</PublicationDate>
<MasterAgreementDate>
<xsl:value-of select="$documentation/fpml:masterAgreement/fpml:masterAgreementDate"/>
</MasterAgreementDate>
<MasterAgreementVersion/>
<AmendmentTradeDate>
<xsl:value-of select="$swTradeHeader/fpml:swAmendmentTradeDate"/>
</AmendmentTradeDate>
<SettlementCurrency/>
<ReferenceCurrency/>
...
<xsl:value-of select="$documentation/fpml:masterConfirmation/fpml:masterConfirmationDate"/>
</MasterConfirmationDate>
<Multiplier/>
<OptionExchange/>
<RelatedExchange/>
...
<EffectiveDate>
<xsl:choose>
<xsl:when test="$swTradeHeader/fpml:swAmendmentEffectiveDate">
<xsl:value-of select="$swTradeHeader/fpml:swAmendmentEffectiveDate"/>
</xsl:when>
<xsl:when test="$swTradeHeader/fpml:swCancellationEffectiveDate">
<xsl:value-of select="$swTradeHeader/fpml:swCancellationEffectiveDate"/>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
</EffectiveDate>
...
<NCNovationBlockID>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swInternalTradeDetails/fpml:swNovationBlockID"/>
</NCNovationBlockID>
<NCNCMID>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swInternalTradeDetails/fpml:tradeId[@tradeIdScheme='NovationConsentId']"/>
</NCNCMID>
<NCRPOldTRN/>
<NCCEqualsCEligible>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swInternalTradeDetails/fpml:ConsentConfirmationEligible"/>
</NCCEqualsCEligible>
<NCSummaryLinkID>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swInternalTradeDetails/fpml:swSummaryLinkId"/>
</NCSummaryLinkID>
<NCORFundId>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="$party[@id=$partyA]/fpml:account/fpml:accountId"/>
</xsl:if>
</NCORFundId>
<NCORFundName>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="$party[@id=$partyA]/fpml:account/fpml:accountName"/>
</xsl:if>
</NCORFundName>
<NCRPFundId>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:party[@id=$partyC]/fpml:account/fpml:accountId"/>
</xsl:if>
</NCRPFundId>
<NCRPFundName>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:party[@id=$partyC]/fpml:account/fpml:accountName"/>
</xsl:if>
</NCRPFundName>
<NCEEFundId>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:party[@id=$partyB]/fpml:account/fpml:accountId"/>
</xsl:if>
</NCEEFundId>
<NCEEFundName>
<xsl:if test="fpml:swLongFormTrade//fpml:novation">
<xsl:value-of select="fpml:swLongFormTrade/fpml:swStructuredTradeDetails/fpml:FpML/fpml:party[@id=$partyB]/fpml:account/fpml:accountName"/>
</xsl:if>
</NCEEFundName>
<NCRecoveryFactor/>
<NCFixedSettlement/>
...
<xsl:value-of select="$contractualTermsSupplementForSwaption/fpml:publicationDate"/>
</NCSwaptionPublicationDate>
<NCOptionDirectionA/>
<xsl:variable name="tiwtri" select="$tradeHeader/fpml:partyTradeIdentifier/fpml:tradeId[@tradeIdScheme='DTCCTradeId']"/>
<TIWDTCCTRI>
<xsl:value-of select="$tiwtri"/>
</TIWDTCCTRI>
<TIWActiveStatus>
<xsl:if test="$tiwtri">Active</xsl:if>
</TIWActiveStatus>
<TIWValueDate>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swValueDate"/>
</TIWValueDate>
<TIWAsOfDate>
<xsl:value-of select="$swExtendedTradeDetails/fpml:swAsOfDate"/>
</TIWAsOfDate>
<CreditPTETradeDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$swCreditDefaultSwapAmendment/fpml:swTradeDate"/>
</xsl:call-template>
</CreditPTETradeDate>
<CreditPTEEffectiveDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$swCreditDefaultSwapAmendment/fpml:swEffectiveDate"/>
</xsl:call-template>
</CreditPTEEffectiveDate>
<CreditPTEFeePaymentDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$swCreditDefaultSwapAmendment/fpml:swFeeDetails/fpml:paymentDate"/>
</xsl:call-template>
</CreditPTEFeePaymentDate>
<CreditPTEFeePayer>
<xsl:variable name="payer" select="string($swCreditDefaultSwapAmendment/fpml:swFeeDetails/fpml:payerPartyReference/@href)"/>
<xsl:choose>
<xsl:when test="$payer=$partyA">A</xsl:when>
<xsl:when test="$payer=$partyB">B</xsl:when>
<xsl:otherwise/>
...
<CreditPTEFeeAmount>
<xsl:value-of select="$swCreditDefaultSwapAmendment/fpml:swFeeDetails/fpml:paymentAmount/fpml:amount"/>
</CreditPTEFeeAmount>
<CreditPTEFeeCurrency>
<xsl:value-of select="$swCreditDefaultSwapAmendment/fpml:swFeeDetails/fpml:paymentAmount/fpml:currency"/>
</CreditPTEFeeCurrency>
...
<xsl:value-of select="$trade/fpml:collateral/fpml:independentAmount/fpml:payerPartyReference/@href"/>
</xsl:variable>
<xsl:choose>
<xsl:when test="$payer=$partyA">A</xsl:when>
<xsl:when test="$payer=$partyB">B</xsl:when>
...
<xsl:if test="$swExtendedTradeDetails/fpml:swTiwPosition">
<PercentagePaymentRule>
<PaymentPercent>
<xsl:variable name="ia_percent" select="$trade/fpml:collateral/fpml:independentAmount/fpml:paymentDetail/fpml:paymentRule/fpml:paymentPercent"/>
<xsl:value-of select="number($ia_percent) * 100"/>
</PaymentPercent>
<NotionalAmountReference>
<xsl:value-of select="$trade/fpml:collateral/fpml:independentAmount/fpml:paymentDetail/fpml:paymentRule/fpml:notionalAmountReference/@href"/>
</NotionalAmountReference>
</PercentagePaymentRule>
</xsl:if>
<Date/>
...
<NotionalSchedule/>
<SendForPublishing>
<xsl:value-of select="$swTradeHeader/fpml:swPublishingDetail/fpml:swSendForPublishing"/>
</SendForPublishing>
<SubscriberId>
<xsl:value-of select="$swTradeHeader/fpml:swSubscriber/fpml:partyId"/>
</SubscriberId>
<ModifiedEquityDelivery>
<xsl:value-of select="boolean($generalTerms/fpml:modifiedEquityDelivery)"/>
</ModifiedEquityDelivery>
<SettledEntityMatrixSource>
<xsl:value-of select="$indexReferenceInformation/fpml:settledEntityMatrix/fpml:matrixSource"/>
</SettledEntityMatrixSource>
<SettledEntityMatrixDate>
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="$indexReferenceInformation/fpml:settledEntityMatrix/fpml:publicationDate"/>
</xsl:call-template>
</SettledEntityMatrixDate>
<AdditionalTerms>
<xsl:choose>
...
<Schema/>
<Fraction>
<xsl:value-of select="$periodicPayment/                                         fpml:fixedAmountCalculation/                                         fpml:dayCountFraction"/>
</Fraction>
</DayCountFraction>
...
<month num="01">Jan</month>
<month num="02">Feb</month>
<month num="03">Mar</month>
<month num="04">Apr</month>
<month num="05">May</month>
<month num="06">Jun</month>
<month num="07">Jul</month>
<month num="08">Aug</month>
<month num="09">Sep</month>
<month num="10">Oct</month>
<month num="11">Nov</month>
<month num="12">Dec</month>
</xsl:template>
<xsl:variable name="months" select="document('')/xsl:stylesheet/xsl:template[@name='months']/*"/>
<xsl:template name="formatDate">
<xsl:param name="date" select="."/>
<xsl:if test="$date">
<xsl:value-of select="concat(                     substring($date, 9, 2), '-',                       $months[@num = substring($date, 6, 2)], '-',                       substring($date, 1, 4))"/>
</xsl:if>
</xsl:template>
...
<xsl:variable name="PayerBIC" select="string($party[@id=$PayerRef]/fpml:partyId)"/>
<xsl:variable name="ReceiverBIC" select="string($party[@id=$ReceiverRef]/fpml:partyId)"/>
<Payer>
...
<xsl:call-template name="formatDate">
<xsl:with-param name="date" select="fpml:paymentDate/fpml:unadjustedDate"/>
</xsl:call-template>
</xsl:if>
</Date>
<Convention>
